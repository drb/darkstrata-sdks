...
const nodePackagePath = path.join(rootDir, 'credential-check', 'node', 'package.json');
...
console.log(`  Updated credential-check/node/package.json`);

// Update Python pyproject.toml
const pythonPath = path.join(rootDir, 'credential-check', 'python', 'pyproject.toml');
...
console.log(`  Updated credential-check/python/pyproject.toml`);

// Update Python constants.py SDK_VERSION
const pythonConstantsPath = path.join(rootDir, 'credential-check', 'python', 'src', 'darkstrata_credential_check', 'constants.py');
if (fs.existsSync(pythonConstantsPath)) {
  ...
  console.log(`  Updated credential-check/python/src/darkstrata_credential_check/constants.py`);
}

// Update Rust Cargo.toml
const rustPath = path.join(rootDir, 'credential-check', 'rust', 'Cargo.toml');
...
console.log(`  Updated credential-check/rust/Cargo.toml`);

// Update Rust Cargo.lock by running cargo check
try {
  console.log(`  Updating credential-check/rust/Cargo.lock...`);
  execSync('cargo check', {
    cwd: path.join(rootDir, 'credential-check', 'rust'),
    stdio: 'inherit',
  });
  console.log(`  Updated credential-check/rust/Cargo.lock`);
} catch (error) {
  console.warn(`  Warning: Failed to update Cargo.lock: ${error.message}`);
}

// Update C# .csproj
const csharpPath = path.join(rootDir, 'credential-check', 'csharp', 'src', 'DarkStrata.CredentialCheck', 'DarkStrata.CredentialCheck.csproj');
if (fs.existsSync(csharpPath)) {
  ...
  console.log(`  Updated credential-check/csharp/src/DarkStrata.CredentialCheck/DarkStrata.CredentialCheck.csproj`);
}

// Update C# Constants.cs SDK_VERSION
const csharpConstantsPath = path.join(rootDir, 'credential-check', 'csharp', 'src', 'DarkStrata.CredentialCheck', 'Constants.cs');
if (fs.existsSync(csharpConstantsPath)) {
  ...
  console.log(`  Updated credential-check/csharp/src/DarkStrata.CredentialCheck/Constants.cs`);
}
