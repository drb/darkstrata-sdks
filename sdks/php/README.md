...
> This SDK is developed in the [darkstrata-sdks](https://github.com/darkstrata/darkstrata-sdks) monorepo under `sdks/php`. The [darkstrata-credential-check-php](https://github.com/darkstrata/darkstrata-credential-check-php) repository is a read-only mirror published for Packagist. Please open issues and pull requests in the monorepo.
